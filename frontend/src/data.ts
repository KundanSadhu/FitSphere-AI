    ...
    days: [
      {
        ...
        exercises: [
          ...
          {
            name: 'Overhead Press', sets: 4, reps: '4-6', restSeconds: 150, videoUrl: 'https://www.youtube.com/watch?v=zoN5EH50Dro', notes: 'Brace core, push head through at the top.', muscleGroup: 'Shoulders',
          ...
          {
            name: 'Dumbbell Flyes', sets: 3, reps: '10-12', restSeconds: 90, videoUrl: 'https://www.youtube.com/watch?v=XRajDdka4BU', notes: 'Stretch the chest muscles.', muscleGroup: 'Chest',
    ...
    days: [
      {
        ...
        exercises: [
          {
            name: 'Muscle-Ups', sets: 5, reps: '3-5', restSeconds: 150, videoUrl: 'https://www.youtube.com/watch?v=uASGBouLpes', notes: 'False grip, explosive pull.', muscleGroup: 'Full Body',
          ...
          {
            name: 'Handstand Push-Ups', sets: 4, reps: '5-8', restSeconds: 120, videoUrl: 'https://www.youtube.com/watch?v=gSjHRuRQ4hk', notes: 'Control the descent, brace core.', muscleGroup: 'Shoulders',
          ...
          {
            name: 'Front Lever Holds', sets: 4, reps: '10s', restSeconds: 120, videoUrl: 'https://www.youtube.com/watch?v=Iuau9zhTM-Q', notes: 'Retract scapula, straight body.', muscleGroup: 'Back',
          ...
          {
            name: 'Pistol Squats', sets: 3, reps: '5/leg', restSeconds: 90, videoUrl: 'https://www.youtube.com/watch?v=jUQzp0KWgQY', notes: 'Balance on one leg, descend fully.', muscleGroup: 'Legs',
    ...
    days: [
      {
        ...
        exercises: [
          {
            name: 'Incline Dumbbell Press', sets: 4, reps: '8-10', restSeconds: 90, videoUrl: 'https://www.youtube.com/watch?v=8fXfwG4ftaQ', notes: 'Focus on maximum chest squeeze at the top and slow control down.', muscleGroup: 'Chest',
          ...
          {
            name: 'Lat Pulldowns (Wide-grip)', sets: 4, reps: '10-12', restSeconds: 75, videoUrl: 'https://www.youtube.com/watch?v=z-lxcsIN4T4', notes: 'Pull with your elbows, keep chest high, feel the lats widen.', muscleGroup: 'Back',
          ...
          {
            name: 'Dumbbell Lateral Raises', sets: 4, reps: '15-20', restSeconds: 60, videoUrl: 'https://www.youtube.com/watch?v=Kl3LEzQ5Zqs', notes: 'Tilt pinkies up slightly. Control the negative — do not swing!', muscleGroup: 'Shoulders',
          ...
          {
            name: 'Incline Dumbbell Bicep Curl', sets: 3, reps: '10-12', restSeconds: 60, videoUrl: 'https://www.youtube.com/watch?v=uCUaRFlA9vE', notes: 'Sit on a 45-degree decline to fully stretch the long bicep head.', muscleGroup: 'Biceps',
          ...
          {
            name: 'Tricep Rope Overhead Press', sets: 3, reps: '12-15', restSeconds: 60, videoUrl: 'https://www.youtube.com/watch?v=NTk0Igxqcsk', notes: 'Keep elbows tucked near your temples to isolate the long head.', muscleGroup: 'Triceps',
      ...
      },
      {
        ...
        exercises: [
          {
            name: 'Barbell Back Squats', sets: 4, reps: '6-8', restSeconds: 120, videoUrl: 'https://www.youtube.com/watch?v=ZaSetOZFo-k', notes: 'Explode up from the parallel state. Maintain core tightness.', muscleGroup: 'Quads',
          ...
          {
            name: 'Walking Dumbbell Lunges', sets: 3, reps: '12 steps/leg', restSeconds: 90, videoUrl: 'https://www.youtube.com/watch?v=P5W2mvm1aGE', notes: 'Step forward deliberately, lowering until back knee almost grazes mat.', muscleGroup: 'Quads',
          ...
          {
            name: 'Standing Calf Raises', sets: 4, reps: '15-20', restSeconds: 60, videoUrl: 'https://www.youtube.com/watch?v=wdOkFomQNp8', notes: 'Pause at the peak concentric contraction and hold for 1 second.', muscleGroup: 'Calves',
      ...
      },
      {
        ...
        exercises: [
          {
            name: 'Conventional Barbell Deadlifts', sets: 3, reps: '5', restSeconds: 150, videoUrl: 'https://www.youtube.com/watch?v=57dg94gYDI0', notes: 'Power through the feet, keep the bar scraping close to your shins.', muscleGroup: 'Back',
          ...
          {
            name: 'Hanging Leg Raises', sets: 3, reps: '15', restSeconds: 60, videoUrl: 'https://www.youtube.com/watch?v=-xPvtoP1BmU', notes: 'Raise legs to parallel or higher without using body momentum.', muscleGroup: 'Core',
    ...
    days: [
      {
        ...
        exercises: [
          {
            name: 'Goblet Squat', sets: 3, reps: '10-12', restSeconds: 90, videoUrl: 'https://www.youtube.com/watch?v=YHEh8i6R5DE', notes: 'Hold kettlebell/dumbbell close to your collarbones. Push through heels.', muscleGroup: 'Quads',
          ...
          {
            name: 'Bent-Over Dumbbell Row', sets: 3, reps: '10', restSeconds: 75, videoUrl: 'https://www.youtube.com/watch?v=f8r7gA3nyb8', notes: 'Keep back flat parallel to the ground. Drive elbows back.', muscleGroup: 'Back',
    ...
    days: [
      {
        ...
        exercises: [
          ...
          {
            name: 'Incline Dumbbell Press', sets: 4, reps: '10-12', restSeconds: 90, videoUrl: 'https://www.youtube.com/watch?v=8fXfwG4ftaQ', notes: 'Focus on upper chest contraction.', muscleGroup: 'Chest',
          ...
          {
            name: 'Pec Deck Machine', sets: 3, reps: '15', restSeconds: 60, videoUrl: 'https://www.youtube.com/watch?v=a9vQ_hwIksU', notes: 'Isolate the chest with constant tension.', muscleGroup: 'Chest',
      ...
      },
      {
        ...
        exercises: [
          {
            name: 'Barbell Squats', sets: 4, reps: '6-8', restSeconds: 150, videoUrl: 'https://www.youtube.com/watch?v=ZaSetOZFo-k', notes: 'Primary leg builder.', muscleGroup: 'Legs',
      ...
      },
      {
        ...
        exercises: [
          {
            name: 'Overhead Press', sets: 4, reps: '6-8', restSeconds: 120, videoUrl: 'https://www.youtube.com/watch?v=zoN5EH50Dro', notes: 'Core shoulder builder.', muscleGroup: 'Shoulders',
          ...
          {
            name: 'Dumbbell Lateral Raise', sets: 4, reps: '15', restSeconds: 60, videoUrl: 'https://www.youtube.com/watch?v=Kl3LEzQ5Zqs', notes: 'Side delt isolation.', muscleGroup: 'Shoulders',
      ...
      },
      {
        ...
        exercises: [
          {
            name: 'Hanging Leg Raises', sets: 4, reps: '15', restSeconds: 60, videoUrl: 'https://www.youtube.com/watch?v=-xPvtoP1BmU', notes: 'Lower ab focus.', muscleGroup: 'Core',
      ...
      },
      {
        ...
        exercises: [
          {
            name: 'Light Treadmill Jogging/Walk', sets: 1, reps: '30 mins', restSeconds: 0, videoUrl: 'https://www.youtube.com/watch?v=88l9eUehvgk', notes: 'Promote blood flow without stress.', muscleGroup: 'Cardio',
          ...
          {
            name: 'Full Body Mobility Flow', sets: 1, reps: '15 mins', restSeconds: 0, videoUrl: 'https://www.youtube.com/watch?v=96Y30OSlZ00', notes: 'Improve recovery and joint health.', muscleGroup: 'Full Body',
...
export const SHOP_PRODUCTS: Product[] = [
  ...
  {
    id: 'p_muscleblaze_whey_pr',
    name: "MuscleBlaze Biozyme Whey Protein PR Powder with 30g Protein, 3g Creatine Monohydrate & 50mg AstraGin, Chocolate Fudge (1kg / 2.2lbs) | Trustified Gold Certified",
    category: 'Supplements',
    price: 3799,
    rating: 4.4,
    image: 'https://img2.hkrtcdn.com/39078/prd_3907761-MuscleBlaze-Biozyme-Performance-Whey-4.4-lb-Chocolate-Hazelnut_o.jpg',
    description: '30g PROTEIN, 3g CREATINE MONOHYDRATE & 50mg ASTRAGIN per scoop. Enhanced Absorption Formula (EAF) ensures 50% higher protein absorption. Trustified Gold certified for purity. Internationally awarded Product of the Year in Sports Nutrition 2021.',
    inStock: true,
    amazonUrl: 'https://www.muscleblaze.com/sv/muscleblaze-biozyme-performance-whey/SP-88093?navKey=VRNT-165145',
    isPrime: true,
    amazonChoice: true,
    brandName: 'MuscleBlaze'
  },
  {
    id: 'p_peppyzone_tshirt',
    name: 'Peppyzone Quick Dry Sports T Shirt for Men | Lightweight Breathable Gym T-Shirt | Regular Fit Workout Tee for Running, Training & Everyday Activewear',
    category: 'Apparel',
    price: 599,
    rating: 4.0,
    image: 'https://m.media-amazon.com/images/I/71jFTfICZAL._SL1500_.jpg',
    description: 'Quick dry sports t-shirt made from lightweight breathable fabric. Regular fit workout tee designed for running, training and everyday activewear.',
    inStock: true,
    amazonUrl: 'https://www.amazon.in/dp/B0G2CCS8SH',
    isPrime: true,
    brandName: 'Peppyzone'
  },
  {
    id: 'p_boldfit_trekking',
    name: 'Boldfit Trekking Shoes for Men Outdoor Hiking Shoes High Neck Footwear Anti Skid Trekking Boots Water Repellent Breathable - Black Grey',
    category: 'Equipment',
    price: 1799,
    rating: 4.0,
    image: 'https://www.boldfit.com/cdn/shop/files/3-1318.jpg?v=1751007199',
    description: 'EXCEPTIONAL DURABILITY FOR OUTDOOR EXPLORATION: Premium trekking shoes with reinforced stitching and rugged construction. Lightweight, breathable mesh with moisture-wicking design. Grippy outsoles for superior traction on varied surfaces.',
    inStock: true,
    amazonUrl: 'https://www.amazon.in/dp/B0DGXHVTRF',
    isPrime: true,
    amazonChoice: true,
    brandName: 'Boldfit'
  },
  {
    id: 'p_muscazo_bench',
    name: '20-in-1 Gym Bench for Home, 30KG PVC Coated Plates Combo Kit, Curl Rod, Straight Bar, Dumbbells, Plates, Skipping Rope, Hand Gripper & Gloves, Complete Workout Kit',
    category: 'Equipment',
    price: 13289,
    rating: 4.0,
    image: 'https://m.media-amazon.com/images/I/61KvwfwV5NL._SX1358_.jpg',
    description: '20-in-1 full-body workout bench with heavy-duty PVC-coated weight plates. Includes 5ft straight bar, 3ft EZ curl rod, adjustable dumbbell rods, skipping rope, hand gripper & padded gym gloves. Supports flat/incline/decline press, leg extensions, lat pulldowns, dips, chest fly, preacher curls and more.',
    inStock: true,
    amazonUrl: 'https://www.amazon.in/dp/B0F9FQBK3J',
    isPrime: true,
    brandName: 'MUSCAZO FITNESS'
  },

  // ========== APPAREL CATEGORY ==========
  {
    id: 'p_atom_scale',
    name: 'ATOM ALISTON K1 Series Digital Kitchen Weighing Scale 10 kg, Electronic Weight Machine with LCD Display for Baking, Cooking, Food & Diet, SF-400',
    category: 'Equipment',
    price: 249,
    rating: 4.2,
    image: 'https://m.media-amazon.com/images/I/71775fRr+gL._SL3000_.jpg',
    description: 'High-precision digital kitchen scale with advanced sensors. Measures 1-10000g in grams/oz. TARE function for net weight. 10kg capacity. Backlit LCD display, carry handle, data lock. Perfect for diet tracking, baking, cooking and meal prep.',
    inStock: true,
    amazonUrl: 'https://www.amazon.in/dp/B083C6XMKQ',
    isPrime: true,
    amazonChoice: true,
    brandName: 'Aliston'
  },
  {
    id: 'p_boldfit_gallon',
    name: 'Boldfit Plastic Gym Gallon Water Bottle 2.5 Liter, Extra Large Leak Proof Fitness Sports Gallon Jug (Black Yellow)',
    category: 'Equipment',
    price: 649,
    rating: 3.9,
    image: 'https://m.media-amazon.com/images/I/61nA7fLNtkL._SL3000_.jpg',
    description: '2.5 litre large capacity BPA-free plastic water bottle. Leak-proof flip top with 2-inch opening for ice cubes. Measurement markers side-printed. Anti-slip handle with strong nylon strap. Perfect for gym, camping, hiking, travel and office.',
    inStock: true,
    amazonUrl: 'https://www.amazon.in/dp/B09GBF7BDL',
    isPrime: true,
    brandName: 'Boldfit'
  }
];
